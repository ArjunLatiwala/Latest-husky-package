...
# run-ci-checks.sh — Smoke and Newman Tests Only
# Used by Husky pre-push
# Only smoke tests and Newman tests should run

echo ""
echo "=================================================="
echo "🚀 [CI Checks] Starting Smoke & Newman Tests"
echo "=================================================="
...
# ---------------------------------------------------------------
# SMOKE TEST: Server startup verification
# ---------------------------------------------------------------
...
echo ""
echo "=================================================="
echo "🧪 [Newman] Starting API tests..."
echo "=================================================="
...
echo ""
echo "=================================================="
echo "✅ [CI Checks] Smoke & Newman tests completed."
echo "=================================================="
