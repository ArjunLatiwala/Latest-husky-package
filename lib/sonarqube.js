...
exports.setupSonarProperties = async () => {
  ...
  // If file already exists and was customised by the user — leave it alone
  if (await fs.pathExists(propsPath)) {
    logInfo(`${SONAR_PROPS_FILE} already exists — keeping existing configuration.`);
    return;
  }
...
sonar.token=${DEFAULT_SONAR_TOKEN || 'REPLACE_WITH_YOUR_TOKEN'}
...
`);
  ...
  logInfo('Edit sonar.host.url and sonar.token (or set as env vars).');
};