...
exports.setupCIScript = async (gitRoot) => {
  ...
  logInfo("To move smoke & Newman tests to pre-commit in future: add './scripts/run-ci-checks.sh' to .husky/pre-commit.");
};
...
exports.setupPrePushHook = async (gitRoot) => {
  ...
  logSuccess("Pre-push hook created — runs smoke and Newman tests only.");
};
